...
public class VoteController {
    ...
    @GetMapping("/voter/{voterId}/participated-elections")
    public List<ElectionResponseDTO> getParticipatedElections(@PathVariable String voterId) {
        return voteService.getParticipatedElections(voterId);
    }
